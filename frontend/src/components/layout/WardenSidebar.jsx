          ...
          <div className="flex w-full items-center justify-between rounded-xl bg-white px-6 py-4 shadow-sm">
            ...
            <div className="flex items-center gap-3">
              <div className="rounded-[12px] border border-gray-100 bg-gray-50 px-4 py-2 hidden sm:block">
                <div className="text-[11px] text-gray-600">Warden</div>
                <div className="text-sm font-semibold text-gray-900">{user?.name || 'Warden'}</div>
              </div>
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-blue-400 to-blue-600 text-white font-bold text-xs">
